...
public:
        ...
        std::vector<std::wstring> compileArguments)
    {
        ...
        rootParameters[0].InitAsUnorderedAccessView((UINT)DVRReg::GlobalHist);
...
public:
        ...
        std::vector<std::wstring> compileArguments)
    {
        ...
        rootParameters[1].InitAsUnorderedAccessView((UINT)DVRReg::Sort);
        rootParameters[2].InitAsUnorderedAccessView((UINT)DVRReg::GlobalHist);
        rootParameters[3].InitAsUnorderedAccessView((UINT)DVRReg::PassHist);
...
public:
        ...
        std::vector<std::wstring> compileArguments)
    {
        ...
        rootParameters[0].InitAsConstants(4, 0);
        rootParameters[1].InitAsUnorderedAccessView((UINT)DVRReg::PassHist);
...
public:
        ...
        std::vector<std::wstring> compileArguments)
    {
        ...
        rootParameters[0].InitAsConstants(4, 0);
        rootParameters[1].InitAsUnorderedAccessView((UINT)DVRReg::Sort);
        rootParameters[2].InitAsUnorderedAccessView((UINT)DVRReg::SortPayload);
        rootParameters[3].InitAsUnorderedAccessView((UINT)DVRReg::Alt);
        rootParameters[4].InitAsUnorderedAccessView((UINT)DVRReg::AltPayload);
        rootParameters[5].InitAsUnorderedAccessView((UINT)DVRReg::GlobalHist);
        rootParameters[6].InitAsUnorderedAccessView((UINT)DVRReg::PassHist);
