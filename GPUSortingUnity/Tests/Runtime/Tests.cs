...
public class Tests : MonoBehaviour
{
    ...
    private DeviceRadixSort m_dvr;
    private OneSweep m_oneSweep;
    ...
    private IEnumerator TestAll()
    {
        ...
        if(m_dvrTotalTestsPassed == k_totalTestsExpected)
            ...
            Debug.Log("DEVICE_RADIX_SORT TESTS FAILED");

        m_oneSweep = new OneSweep(oneSweep);
        if (m_oneSweep.Valid)
        ...
        if (m_osTotalTestsPassed == k_totalTestsExpected)
            ...
            Debug.Log("ONESWEEP TESTS FAILED");
